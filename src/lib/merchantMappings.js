...
export const merchantMappings = {
  ...
  // 🍔 快餐/連鎖
  '麥當勞': { category: '餐飲美食', icon: '🍔', keywords: ['麥當勞', 'mcdonald', 'McDonald', 'MCD'] },
  ...
  '吉野家': { category: '餐飲美食', icon: '🍛', keywords: ['吉野家', 'Yoshinoya'] },
  ...
  '瑞幸咖啡': { category: '餐飲美食', icon: '☕', keywords: ['瑞幸', 'luckin'] },
  '庫迪咖啡': { category: '餐飲美食', icon: '☕', keywords: ['庫迪', 'cotti'] },
  ...
  '的士': { category: '交通出行', icon: '🚕', keywords: ['的士', 'taxi'] },
  '港鐵': { category: '交通出行', icon: '🚇', keywords: ['港鐵', 'MTR', 'mtr'] },
  'MTR': { category: '交通出行', icon: '🚇', keywords: ['港鐵', 'MTR'] },
  '九巴': { category: '交通出行', icon: '🚌', keywords: ['九巴', 'KMB'] },
  '城巴': { category: '交通出行', icon: '🚌', keywords: ['城巴', 'Citybus'] },
  '新巴': { category: '交通出行', icon: '🚌', keywords: ['新巴', 'NWFB'] },
  'Tesla': { category: '交通出行', icon: '🚗', keywords: ['tesla', 'Tesla'] },
  
  // 🍔 外賣平台
  'Foodpanda': { category: '餐飲美食', icon: '🍔', keywords: ['foodpanda', 'Foodpanda', '熊貓外賣'] },
  'Deliveroo': { category: '餐飲美食', icon: '🍔', keywords: ['deliveroo', 'Deliveroo', '户户送'] },
  ...
  '海洋公園': { category: '娛樂休閒', icon: '🎢', keywords: ['海洋公園', 'Ocean Park'] },
  '迪士尼': { category: '娛樂休閒', icon: '🏰', keywords: ['迪士尼', 'Disneyland', '迪士尼樂園'] },
